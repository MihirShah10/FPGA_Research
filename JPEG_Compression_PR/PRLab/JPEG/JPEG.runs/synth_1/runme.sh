...
HD_PWD='/home/mihir/jpeg/jpeg_PR/PRLab/JPEG/JPEG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jpeg_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jpeg_design_wrapper.tcl
