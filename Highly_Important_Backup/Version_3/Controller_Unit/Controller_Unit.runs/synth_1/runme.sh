...
HD_PWD='C:/JPEG_Thesis_2/Controller_Unit/Controller_Unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_bram_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_module_bram_fpga.tcl
