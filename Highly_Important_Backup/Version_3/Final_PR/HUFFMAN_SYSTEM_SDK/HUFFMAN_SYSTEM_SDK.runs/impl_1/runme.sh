...
HD_PWD='C:/JPEG_Thesis_2/Final_PR/HUFFMAN_SYSTEM_SDK/HUFFMAN_SYSTEM_SDK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log huffman_system_sdk_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source huffman_system_sdk_wrapper.tcl -notrace
