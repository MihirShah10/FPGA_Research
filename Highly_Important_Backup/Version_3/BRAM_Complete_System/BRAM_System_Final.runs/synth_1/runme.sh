...
HD_PWD='C:/JPEG_Thesis_2/BRAM_Complete_System/BRAM_System_Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_design_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_design_system_wrapper.tcl
