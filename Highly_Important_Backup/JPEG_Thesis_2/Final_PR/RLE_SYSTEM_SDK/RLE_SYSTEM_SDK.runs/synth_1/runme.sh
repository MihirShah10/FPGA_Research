...
HD_PWD='C:/JPEG_Thesis_2/Final_PR/RLE_SYSTEM_SDK/RLE_SYSTEM_SDK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rle_system_sdk_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rle_system_sdk_wrapper.tcl
