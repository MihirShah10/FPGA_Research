...
HD_PWD='C:/JPEG_Thesis_2/Final_PR/HUFFMAN_SYSTEM_SDK/HUFFMAN_SYSTEM_SDK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log huffman_system_sdk_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source huffman_system_sdk_wrapper.tcl
