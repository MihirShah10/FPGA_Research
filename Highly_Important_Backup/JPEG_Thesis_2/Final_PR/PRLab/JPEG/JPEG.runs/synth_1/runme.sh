...
HD_PWD='C:/JPEG_Thesis_2/Final_PR/PRLab/JPEG/JPEG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jpeg_pr_ddr_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jpeg_pr_ddr_design_wrapper.tcl
