...
#
# Generated by export_simulation on Wed Nov 22 00:01:31 -0600 2017
#
################################################################################
...
switch to the './jpeg_pr_ddr_design.sh' script.

./jpeg_pr_ddr_design.sh -reset_run
...
./jpeg_pr_ddr_design.sh -noclean_files

For more information on the script, please type './jpeg_pr_ddr_design.sh -help'.
