...
HD_PWD='C:/JPEG_Thesis_2/Final_PR/HUFFMAN_TEST_MAIN/HUFFMAN_TEST_MAIN.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log jpeg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jpeg.tcl
