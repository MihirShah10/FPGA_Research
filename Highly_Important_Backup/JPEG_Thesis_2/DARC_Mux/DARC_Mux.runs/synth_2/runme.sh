...
HD_PWD='C:/JPEG_Thesis_2/DARC_Mux/DARC_Mux.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log DARC_Mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DARC_Mux.tcl
