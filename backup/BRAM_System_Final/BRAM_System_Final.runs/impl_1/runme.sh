...
HD_PWD='C:/JPEG_Thesis_2/BRAM_System_Final/BRAM_System_Final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_design_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bram_design_system_wrapper.tcl -notrace
