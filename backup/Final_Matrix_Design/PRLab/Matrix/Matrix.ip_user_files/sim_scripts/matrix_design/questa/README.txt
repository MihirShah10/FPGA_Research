...
#
# Generated by export_simulation on Wed Oct 18 21:18:32 EDT 2017
#
################################################################################
...
switch to the './matrix_design.sh' script.

./matrix_design.sh -reset_run
...
./matrix_design.sh -noclean_files

For more information on the script, please type './matrix_design.sh -help'.
