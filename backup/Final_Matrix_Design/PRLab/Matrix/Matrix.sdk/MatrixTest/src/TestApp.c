...
int get_matrixadd()
{
	...
	*(filter_addr+0) = 0x04030201; //A
	*(filter_addr+1) = 0x08070605; //B
...
int main()
{
	...
	SD_TransferPartial("multiplication.bin", PARTIAL_MULTIPLICATION_ADDR, (PARTIAL_MULTIPLICATION_BITFILE_LEN << 2));
	...
	while(Exit != 1) {
		do {
			print("Select the Matrix Operation\n\r");
			print("    1: Matrix Addition filter\n\r");
			print("    2: Matrix Multiplication filter\n\r");
			print("    0: Exit\n\r");
			print("> ");
