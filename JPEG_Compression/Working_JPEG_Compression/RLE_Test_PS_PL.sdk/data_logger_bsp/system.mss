...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = DARC_DCT
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = DARC_DCT_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = DARC_HUFFMAN
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = DARC_HUFFMAN_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = DARC_QUANTZ
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = DARC_QUANTZ_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = DARC_RLE
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = DARC_RLE_0
END
