...
HD_PWD='C:/JPEG_Thesis/RLE/RLE_Test_PS_PL/RLE_Test_PS_PL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rle_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rle_design_wrapper.tcl -notrace
