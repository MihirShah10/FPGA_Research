...
HD_PWD='C:/JPEG_Thesis/RLE/RLE_Test_PS_PL/RLE_Test_PS_PL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rle_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rle_design_wrapper.tcl
