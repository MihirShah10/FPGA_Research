...
HD_PWD='C:/JPEG_Thesis/DARC_DCT_App/DARC_DCT_App.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DARC_DCT_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DARC_DCT_Design_wrapper.tcl -notrace
