...
HD_PWD='C:/JPEG_Thesis/DARC_DCT_App/DARC_DCT_App.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DARC_DCT_Design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DARC_DCT_Design_wrapper.tcl
