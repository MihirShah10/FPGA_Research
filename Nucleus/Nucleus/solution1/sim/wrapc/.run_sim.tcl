...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Matrix_Addition.autotvin.dat"
	set constFileTvOut       "Matrix_Addition.autotvout.dat"
	set constFileHdlTvIn     "Matrix_Addition.autohdltvin.dat"
	set constFileHdlTvOut    "Matrix_Addition.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
