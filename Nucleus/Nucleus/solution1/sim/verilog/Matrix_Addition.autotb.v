...
`define AUTOTB_DUT      Matrix_Addition
`define AUTOTB_DUT_INST AESL_inst_Matrix_Addition
`define AUTOTB_TOP      apatb_Matrix_Addition_top
`define AUTOTB_LAT_RESULT_FILE "Matrix_Addition.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "Matrix_Addition.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_Matrix_Addition_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_BRAM_D AESL_autobram_D
`define AESL_BRAM_INST_D bram_inst_D
`define AESL_BRAM_E AESL_autobram_E
`define AESL_BRAM_INST_E bram_inst_E
...
`define AUTOTB_TVIN_D_out_wrapc  "../tv/rtldatafile/rtl.Matrix_Addition.autotvin_D.dat"
`define AUTOTB_TVIN_E_out_wrapc  "../tv/rtldatafile/rtl.Matrix_Addition.autotvin_E.dat"
`define AUTOTB_TVOUT_E  "../tv/cdatafile/c.Matrix_Addition.autotvout_E.dat"
`define AUTOTB_TVOUT_E_out_wrapc  "../tv/rtldatafile/rtl.Matrix_Addition.autotvout_E.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 40;
parameter LENGTH_D = 4;
parameter LENGTH_E = 4;
...
// The input and output of bramD
wire  bramD_Clk_A, bramD_Clk_B;
wire  bramD_EN_A, bramD_EN_B;
wire  [4 - 1 : 0] bramD_WEN_A, bramD_WEN_B;
wire    [31 : 0]    bramD_Addr_A, bramD_Addr_B;
wire    [31 : 0]    bramD_Din_A, bramD_Din_B;
wire    [31 : 0]    bramD_Dout_A, bramD_Dout_B;
wire    bramD_ready;
wire    bramD_done;

`AESL_BRAM_D `AESL_BRAM_INST_D(
    .Clk_A    (bramD_Clk_A),
    .Rst_A    (bramD_Rst_A),
    .EN_A     (bramD_EN_A),
    .WEN_A    (bramD_WEN_A),
...
// Assignment between dut and bramD
assign bramD_Clk_A = D_CLK_A;
assign bramD_Rst_A = D_RST_A;
assign bramD_Addr_A = D_ADDR_A;
assign bramD_EN_A = D_EN_A;
assign D_DOUT_A = bramD_Dout_A;
assign bramD_WEN_A = 0;
assign bramD_Din_A = 0;
assign bramD_WEN_B = 0;
assign bramD_Din_B = 0;
assign bramD_ready=    ready;
assign bramD_done = 0;


//------------------------bramE Instantiation--------------

// The input and output of bramE
wire  bramE_Clk_A, bramE_Clk_B;
wire  bramE_EN_A, bramE_EN_B;
wire  [4 - 1 : 0] bramE_WEN_A, bramE_WEN_B;
wire    [31 : 0]    bramE_Addr_A, bramE_Addr_B;
wire    [31 : 0]    bramE_Din_A, bramE_Din_B;
wire    [31 : 0]    bramE_Dout_A, bramE_Dout_B;
wire    bramE_ready;
wire    bramE_done;

`AESL_BRAM_E `AESL_BRAM_INST_E(
    .Clk_A    (bramE_Clk_A),
    .Rst_A    (bramE_Rst_A),
    .EN_A     (bramE_EN_A),
    .WEN_A    (bramE_WEN_A),
...
// Assignment between dut and bramE
assign bramE_Clk_A = E_CLK_A;
assign bramE_Rst_A = E_RST_A;
assign bramE_Addr_A = E_ADDR_A;
assign bramE_EN_A = E_EN_A;
assign bramE_WEN_A = E_WEN_A;
assign bramE_Din_A = E_DIN_A;
assign bramE_WEN_B = 0;
assign bramE_Din_B = 0;
assign bramE_ready= ready_initial | bramE_done;
assign bramE_done =    AESL_done_delay;
...
reg dump_tvout_finish_E;

initial begin : dump_tvout_runtime_sign_E
    integer fp;
    dump_tvout_finish_E = 0;
    fp = $fopen(`AUTOTB_TVOUT_E_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_E_out_wrapc);
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_E_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_E_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
