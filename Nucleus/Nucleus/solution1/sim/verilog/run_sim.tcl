...
if {[file isfile Matrix_Addition.autotvin.dat]} {
	file delete -force Matrix_Addition.autotvin.dat
}

if {[file isfile Matrix_Addition.autotvout.dat]} {
	file delete -force Matrix_Addition.autotvout.dat
}
