...
proc create_root_design { parentCell } {
  ...
  # Create instance: Matrix_Addition_0, and set properties
  set Matrix_Addition_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Matrix_Addition:1.0 Matrix_Addition_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /Matrix_Addition_0/s_axi_CRTL_BUS]

  # Create instance: Matrix_Addition_0_bram, and set properties
  set Matrix_Addition_0_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 Matrix_Addition_0_bram ]
  set_property -dict [ list \
...
CONFIG.use_bram_block.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: Matrix_Multiply_0, and set properties
  set Matrix_Multiply_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Matrix_Multiply:1.0 Matrix_Multiply_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /Matrix_Multiply_0/s_axi_CRTL_BUS]

  # Create instance: Matrix_Multiply_0_bram, and set properties
  set Matrix_Multiply_0_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 Matrix_Multiply_0_bram ]
  set_property -dict [ list \
CONFIG.Enable_B {Use_ENB_Pin} \
CONFIG.Memory_Type {True_Dual_Port_RAM} \
CONFIG.Port_B_Clock {100} \
...
CONFIG.use_bram_block.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: Matrix_Multiply_0_bram_0, and set properties
  set Matrix_Multiply_0_bram_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 Matrix_Multiply_0_bram_0 ]
  set_property -dict [ list \
CONFIG.Enable_B {Use_ENB_Pin} \
CONFIG.Memory_Type {True_Dual_Port_RAM} \
CONFIG.Port_B_Clock {100} \
...
CONFIG.NUM_MI {4} \
  ...
  connect_bd_intf_net -intf_net Matrix_Addition_0_D_PORTA [get_bd_intf_pins Matrix_Addition_0/D_PORTA] [get_bd_intf_pins Matrix_Multiply_0_bram_0/BRAM_PORTB]
  connect_bd_intf_net -intf_net Matrix_Addition_0_E_PORTA [get_bd_intf_pins Matrix_Addition_0/E_PORTA] [get_bd_intf_pins Matrix_Addition_0_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net Matrix_Multiply_0_A_PORTA [get_bd_intf_pins Matrix_Multiply_0/A_PORTA] [get_bd_intf_pins Matrix_Multiply_0_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net Matrix_Multiply_0_C_PORTA [get_bd_intf_pins Matrix_Multiply_0/C_PORTA] [get_bd_intf_pins Matrix_Multiply_0_bram_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins Matrix_Multiply_0_bram/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins Matrix_Addition_0_bram/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_1/BRAM_PORTA]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Matrix_Multiply_0/s_axi_CRTL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins Matrix_Addition_0/s_axi_CRTL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Matrix_Addition_0/ap_clk] [get_bd_pins Matrix_Multiply_0/ap_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Matrix_Addition_0/ap_rst_n] [get_bd_pins Matrix_Multiply_0/ap_rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Matrix_Addition_0/s_axi_CRTL_BUS/Reg] SEG_Matrix_Addition_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Matrix_Multiply_0/s_axi_CRTL_BUS/Reg] SEG_Matrix_Multiply_0_Reg
...
preplace inst Matrix_Multiply_0_bram_0 -pg 1 -lvl 5 -y -160 -defaultsOSRD
preplace inst Matrix_Multiply_0_bram -pg 1 -lvl 5 -y -290 -defaultsOSRD
preplace inst Matrix_Multiply_0 -pg 1 -lvl 3 -y -270 -defaultsOSRD
preplace inst Matrix_Addition_0_bram -pg 1 -lvl 5 -y -30 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y -210 -defaultsOSRD
preplace inst Matrix_Addition_0 -pg 1 -lvl 3 -y -110 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 4 -y -300 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y -350 -defaultsOSRD
preplace inst axi_bram_ctrl_1 -pg 1 -lvl 4 -y 10 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y -190 -defaultsOSRD
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 2 N -200 990J
preplace netloc processing_system7_0_DDR 1 1 5 330J -420 NJ -420 NJ -420 NJ -420 1680J
preplace netloc Matrix_Multiply_0_A_PORTA 1 3 2 1020J -230 1440
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 4 1 1430
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 370J
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 3 350 30 660 30 1030J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 -50 -460 320
preplace netloc ps7_0_axi_periph_M03_AXI 1 2 2 NJ -180 990
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 640
preplace netloc Matrix_Addition_0_E_PORTA 1 3 2 NJ -110 1440
preplace netloc processing_system7_0_FIXED_IO 1 1 5 340J -390 NJ -390 NJ -390 NJ -390 1670J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 -40 10 380 10 650 10 1010J
preplace netloc axi_bram_ctrl_1_BRAM_PORTA 1 4 1 1430
preplace netloc Matrix_Addition_0_D_PORTA 1 3 2 N -130 1430
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 640
preplace netloc Matrix_Multiply_0_C_PORTA 1 3 2 1000J -170 N
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 360
levelinfo -pg 1 -70 140 510 830 1310 1570 1920 -top -530 -bot 130
",
}
