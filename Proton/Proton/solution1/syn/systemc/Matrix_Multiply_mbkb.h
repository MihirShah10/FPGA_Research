...
#ifndef __Matrix_Multiply_mbkb__HH__
#define __Matrix_Multiply_mbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Matrix_Multiply_mbkb) {
    ...
    SC_CTOR(Matrix_Multiply_mbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
