...
void AESL_WRAP_Matrix_Multiply (
int A[8],
int C[4])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *C_pc_buffer = new sc_bv<32>[4];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: C
				{
					...
					// {
						// celement: C(31, 0)
						// {
							sc_lv<32>* C_lv0_0_3_1 = new sc_lv<32>[4];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: C(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								{
									C_lv0_0_3_1[hls_map_index++].range(31, 0) = sc_bv<32>(C_pc_buffer[hls_map_index].range(31, 0));
								}
							}
						}
					}
					...
					// bitslice(31, 0)
					{
						...
						// celement: C(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								// output_type_conversion : (C_lv0_0_3_1[hls_map_index++]).to_uint64()
								if (&(C[0]) != NULL) // check the null address if the c port is array or others
								{
									C[i_0] = (C_lv0_0_3_1[hls_map_index++]).to_uint64();
								}
							}
						}
					}
	...
	else
	{
		...
		sc_bv<32>* C_tvin_wrapc_buffer = new sc_bv<32>[4];
		...
		tcl_file.set_num(4, &tcl_file.C_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* C_tvout_wrapc_buffer = new sc_bv<32>[4];
